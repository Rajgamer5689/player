...
#
#    elif message.text == 'Admin Mod9;e':
...
def send_text(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "An error has occured , contact admin @therajop")
...
@bot.message_handler(content_types=["text"], func=lambda message: message.text == "Adminomlyrajcanaacwj@@Mode")
